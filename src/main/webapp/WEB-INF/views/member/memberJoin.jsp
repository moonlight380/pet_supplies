...
<div class="container" >
  <form action="./memberJoin" method="post" id="Joinfrm">
...
<td><input id="id" name="id" class="input_Join" placeholder="" value="" type="text"><span id="idt"></span></td>
 </tr>
<tr>
<th scope="row">비밀번호 <img src="${pageContext.request.contextPath}/resources/images/ico_required.gif" alt="필수"></th>
 <td><input id="pw" name="pw" class="input_Join" autocomplete="off" maxlength="16" value="" type="password"><span id="pwt"></span></td>
 </tr>
<tr>
...
<td><input id="hint_answer" name="hint_answer" class="input_Join" placeholder="" value="" type="text"><span id="answer"></span></td>
</tr>

<tr>
<th scope="row" id="nameTitle">이름 <img src="${pageContext.request.contextPath}/resources/images/ico_required.gif" alt="필수"></th>
  <td>
    <input type="text" name="name" id="name" class="input_Join" maxlength="20"><span id="nameContents"></span>
  </td>
</tr>

<tr>
<th scope="row">이메일 <img src="${pageContext.request.contextPath}/resources/images/ico_required.gif" alt="필수"></th>
 <td><input id="email" name="email" class="input_Join" value="" type="email"><span id="emailCheck"></span>
 </td>
</tr>
...
<th scope="row">주소 <img src="${pageContext.request.contextPath}/resources/images/ico_required.gif" class="" alt="필수"></th>
 <td>
   <input id="postcode1" name="address" class="input_Join" placeholder="" readonly="readonly" maxlength="14" value="" type="text"><span>우편번호</span>
   <input type="button" onclick="sample6_execDaumPostcode()" value="우편번호 찾기"><br>
   <input id="addr1" name="addr1" class="input_Join" placeholder="" readonly="readonly" value="" type="text" > 기본주소<br>
   <input id="addr2" name="addr2" class="input_Join" placeholder="" value="" type="text"> 나머지주소 </td>
</tr>
<tr class="">
...
</select>-<input id="mobile2" name="phone" class="input_Join tel" maxlength="4" value="" type="text">-<input id="mobile3" class="input_Join tel" name="phone" maxlength="4" value="" type="text">
...
<div id = "result" class="agreeAll" style="background-color: #ffffff; border: 1px solid gray;">
	<h3>전체 동의</h3>
	
	<input type="checkbox" hidden="" id="checkAll" class="ac">
	<div class="ec-base-box gStrong" style="border: 1px solid black;">
	<p><span class="ec-base-chk ac checkcon"><i class="fa fa-check-circle" id="All"  style="font-size:24px; border: 1px solid red; float: left; margin-left: 2%"></i>
	<em class="checkbox"></em></span>&nbsp;
	<label for="sAgreeAllChecked" style="display: inline; border: 1px solid red;" class="ac"><strong>이용약관 및 개인정보수집 및 이용, 쇼핑정보 수신(선택)에 모두 동의합니다.</strong></label></p>
	</div>

	
	<div class="ec-base-box typeThinBg agreeArea">
	<h4 style="margin-top: 20px; margin-left: 2%; font-weight: bold;">[필수] 이용약관 동의</h4>
	<div class="ec-base-box typeThinBg agreeArea" style="width:95%; height: 350px; border: 1px solid #d7d5d5; margin : 0 auto;">
...
부 칙(시행일) 이 약관은 년 월 일부터 시행합니다.			</div>
	<p class="check"><span>이용약관에 동의하십니까?</span> <input id="check01" class="ch1" name="agree_service_check[]" value="1" type="checkbox"><label for="agree_service_check0">동의함</label></p>
	</div>
	</div>
	
	<div class="ec-base-box typeThinBg agreeArea">
	<h4 style="margin-top: 20px; margin-left: 2%; font-weight: bold;">[필수] 개인정보 수집 및 이용 동의</h4>
	<input class="check01" type="checkbox" hidden="">
	<div class="ec-base-box typeThinBg agreeArea" style="width:95%; height: 350px; border: 1px solid #d7d5d5; margin : 0 auto;">
		<div class="content" style="height: 300px; border: 1px solid #d7d5d5; font-size: small; overflow: scroll;">
		...
		<p class="check"><span>개인정보 수집 및 이용에 동의하십니까?</span> <input id="check02" class="ch1" name="agree_privacy_check[]" value="1" type="checkbox"><label for="agree_privacy_check0">동의함</label></p>
		</div>
	</div>
	...
	<div class="ec-base-box typeThinBg agreeArea" style="width:95%; height: 200px; border: 1px solid #d7d5d5; margin : 0 auto;">
	...
	<p class="check">
		<span>이메일 수신을 동의하십니까?</span><input id="check03" class="ch1" name="is_news_mail" type="checkbox"> <label for="is_news_mail0">동의함</label>	
	</p>
	</div>
	 </div>
</div>

	<div class="agreeBtn" style="margin-left: 40%; border: 1px solid red; margin-top: 50px;">
		<button id="btnCancel" type="submit" class="btn btn-danger" onclick="goback()">취소하기</button>
		<button id="btnJoin" type="submit" class="btn btn-primary active" style="font-size: small;">가입하기</button>
	</div>
